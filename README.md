...
在本次“Hello World 挑战”中，你将不再是旁观者，而是真正的参与者。我们将以教师提供的教学项目为起点，从最基础的搜索、收藏开始，一步步完成代码的下载、本地运行、修改，。通过这一系列实战操作，你将亲手解锁 GitHub 的核心技能，为未来的编程与协作学习打下坚实基础。准备好了吗？让我们开始这段奇妙的代码之旅吧！
...
- **任务目标**：将教师的仓库完整复制一份到你自己的 GitHub 账号下。
